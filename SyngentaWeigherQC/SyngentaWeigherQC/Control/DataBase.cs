        ...
        try
        {
          ...
          if (db.InforLines.Count() <= 0)
          {
            await db.InforLines.AddRangeAsync(new InforLine[]
            {
              ...
              new InforLine(){Name = "KL2", Code = "KL2", PathReportLocal = "", PassReport = "1", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsEnable=true},
              new InforLine(){Name = "KL1", Code = "KL1", PathReportLocal = "", PassReport = "1", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsEnable=true},
