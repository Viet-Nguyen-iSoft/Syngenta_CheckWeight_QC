...
namespace SyngentaWeigherQC.Helper
{
  public class ExcelHelper
  {
    ...
    //    //Test Copy Sheet
    //    // Lấy sheet gốc
    //    var originalSheet = workbook.Worksheet("Template");
    //    // Tạo bản sao của sheet đó với tên mới
    //    var copiedSheet = originalSheet.CopyTo("Page111");
    //    string path = pathFolderSave[0] + "\\Acopy.xlsx";
